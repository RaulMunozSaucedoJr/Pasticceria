    ...
    function n(h, s, c) {
        (c = c || e || t.jQuery) && (s.prototype.option || (s.prototype.option = function (t) {
            ...
            return r = i, l = "$()." + h + '("' + (o = t) + '")', (e = this).each(function (t, e) {
                ...
                s ? (i = s[o]) && "_" != o.charAt(0) ? (n = i.apply(s, r), a = void 0 === a ? n : a) : u(l + " is not a valid method") : u(h + " not initialized. Cannot call methods, i.e. " + l)
            }), void 0 !== a ? a : e
        }, o(c))
    }
...
function (t, e) {
    ...
    function D(t) {
        var e, i, n;
        if (k || (k = !0, (e = document.createElement("div")).style.width = "200px", e.style.padding = "1px 2px 3px 4px", e.style.borderStyle = "solid", e.style.borderWidth = "1px 2px 3px 4px", e.style.boxSizing = "border-box", (i = document.body || document.documentElement).appendChild(e), n = x(e), w = 200 == Math.round(E(n.width)), D.isBoxSizeOuter = w, i.removeChild(e)), "string" == typeof t && (t = document.querySelector(t)), t && "object" == typeof t && t.nodeType) {
            var s = x(t);
            ...
            for (var r = o.isBorderBox = "border-box" == s.boxSizing, a = 0; a < C; a++) {
                var l = S[a],
                    h = s[l],
                    c = parseFloat(h);
                o[l] = isNaN(c) ? 0 : c
            ...
            var d = o.paddingLeft + o.paddingRight,
                ...
                p = o.marginTop + o.marginBottom,
                g = o.borderLeftWidth + o.borderRightWidth,
                v = o.borderTopWidth + o.borderBottomWidth,
                m = r && w,
                y = E(s.width);
            !1 !== y && (o.width = y + (m ? 0 : d + g));
            var b = E(s.height);
            return !1 !== b && (o.height = b + (m ? 0 : u + v)), o.innerWidth = o.width - (d + g), o.innerHeight = o.height - (u + v), o.outerWidth = o.width + f, o.outerHeight = o.height + p, o
        }
    }
    return D
}),
...
function (r, a) {
    ...
    a.extend(p, t.prototype), p._create = function () {
        ...
        var n, s, o;
        this.slides = [], this.cells.length && (n = new r(this), this.slides.push(n), s = "left" == this.originSide ? "marginRight" : "marginLeft", o = this._getCanCellFit(), this.cells.forEach(function (t, e) {
            var i;
            n.cells.length && (i = n.outerWidth - n.firstMargin + (t.size.outerWidth - t.size[s]), o.call(this, e, i) || (n.updateTarget(), n = new r(this), this.slides.push(n))), n.addCell(t)
    ...
    return p.setCellAlign = function () {
        ...
        var t, e, i, n, s, o, r;
        this.options.contain && !this.options.wrapAround && this.cells.length && (e = (t = this.options.rightToLeft) ? "marginRight" : "marginLeft", i = t ? "marginLeft" : "marginRight", n = this.slideableWidth - this.getLastCell().size[i], s = n < this.size.innerWidth, o = this.cursorPosition + this.cells[0].size[e], r = n - this.size.innerWidth * (1 - this.cellAlign), this.slides.forEach(function (t) {
            s ? t.target = n * this.cellAlign : (t.target = Math.max(t.target, o), t.target = Math.min(t.target, r))
        }, this))
    }, p.dispatchEvent = function (t, e, i) {
        var n, s, o = e ? [e].concat(i) : i;
        this.emitEvent(t, o), l && this.$element && (n = t += this.options.namespaceJQueryEvents ? ".flickity" : "", e && ((s = l.Event(e)).type = t, n = s), this.$element.trigger(n, i))
...
function (n, s) {
    ...
    return n.pointerDownFocus = function (t) {
        ...
        var n, s, o, r;
        this.isDraggable && (t.preventDefault(), this.previousDragX = this.dragX, n = this.options.rightToLeft ? -1 : 1, this.options.wrapAround && (i.x = i.x % this.slideableWidth), o = this.dragStartPosition + i.x * n, !this.options.wrapAround && this.slides.length && (o = (o = (s = Math.max(-this.slides[0].target, this.dragStartPosition)) < o ? .5 * (o + s) : o) < (r = Math.min(-this.getLastSlide().target, this.dragStartPosition)) ? .5 * (o + r) : o), this.dragX = o, this.dragMoveTime = new Date, this.dispatchEvent("dragMove", t, [e, i]))
...
function (t, i) {
    ...
    return i.insert = function (t, e) {
        var i, n, s, o, r, a, l, h = this._makeCells(t);
        h && h.length && (i = this.cells.length, e = void 0 === e ? i : e, s = h, o = document.createDocumentFragment(), s.forEach(function (t) {
            o.appendChild(t.element)
        }), n = o, (r = e == i) ? this.slider.appendChild(n) : (a = this.cells[e].element, this.slider.insertBefore(n, a)), 0 === e ? this.cells = h.concat(this.cells) : r ? this.cells = this.cells.concat(h) : (l = this.cells.splice(e, i - e), this.cells = this.cells.concat(h).concat(l)), this._sizeCells(h), this.cellChange(e, !0))
    }, i.append = function (t) {
...
function (t, e) {
    ...
    return t._createAsNavFor = function () {
        ...
        var e, i, n, s, o, r, a, l, h = this.navCompanion && this.navCompanion.selectedCells;
        h && (e = h[0], n = (i = this.navCompanion.cells.indexOf(e)) + h.length - 1, s = Math.floor((o = i, r = n, a = this.navCompanion.cellAlign, (r - o) * a + o)), this.selectCell(s, !1, t), this.removeNavSelectedElements(), s >= this.cells.length || (l = this.cells.slice(i, 1 + n), this.navSelectedElements = l.map(function (t) {
            return t.element
    ...
    function h(t, e, i) {
        ...
        if (e && c[e]) {
            ...
            if ("string" == typeof this.options.background)
                for (var o = t.querySelectorAll(this.options.background), n = 0; n < o.length; n++) {
                    var r = o[n];
